...
def main():
    ...
    output_sentence_0 = json.loads(thisdir.joinpath("all_sentences_0.json").read_text())
    output_sentence_1 = json.loads(thisdir.joinpath("all_sentences_1.json").read_text())
    output_sentence_2 = json.loads(thisdir.joinpath("all_sentences_2.json").read_text())
    ...
    for i, sentence in enumerate(output_sentence_0, start=1):
        distance = np.linalg.norm(center - np.array(sentence["emotion"]))
